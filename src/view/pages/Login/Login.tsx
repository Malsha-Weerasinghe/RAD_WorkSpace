...
export class Login extends Component {
    render() {
        return (
           <div className="flex h-screen bg-[#458970]">
               <div className="h-auto mt-4 mb-4 pl-9 pr-9 mx-auto border-gray-500 border-[0.5px]">
                   ...
                   <form className="h-auto p-2 justify-center">
                        ...
                        <div className="pb-2">
                            ...
                            <input className="float-right border-[1px] border-green-200 w-3/4" type="email"/>
                        </div>
                       ...
                       <div className="mt-2">
                           <button className="mt-5 w-full p-[6px] bg-green-400 text-[14px]">Sign In</button>
                       </div>
